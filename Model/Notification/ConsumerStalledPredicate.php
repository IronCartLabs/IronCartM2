...
final class ConsumerStalledPredicate
{
     ...
     * up within a single cron tick under default `cron_consumers_runner`
     * timing) has time to flip to `running`, but short enough that the
     * notice fires within one admin-refresh cycle on a truly stuck
     * install.
     */
